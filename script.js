...
function updateProductAtIndex(index) {
    const products = JSON.parse(localStorage.getItem('optixProducts')) || [];
    
    // Update the object at the specific index
    products[index].category = document.getElementById('nType').value;
    products[index].code = document.getElementById('nCode').value;
    products[index].name = document.getElementById('nName').value;
    products[index].brand = document.getElementById('nBrand').value;
    products[index].color = document.getElementById('nColor').value;
    products[index].size = document.getElementById('nSize').value;
    products[index].gender = document.getElementById('nGender').value;
    products[index].material = document.getElementById('nMaterial').value;
    products[index].shape = document.getElementById('nShape').value;
    products[index].buyPrice = parseFloat(document.getElementById('nBuy').value) || 0;
    products[index].sellPrice = parseFloat(document.getElementById('nSell').value) || 0;
    products[index].qty = parseInt(document.getElementById('nQty').value) || 0;
...
function saveOrder(openInNewTab = false) {
    ...
    const totalPaidNow = parseFloat(document.getElementById('txtTotalPaid').value) || 0;
    ...
    const updatedOrder = {
        ...
        amount: payableNow,
        paid: totalPaidNow,
        paidCash: parseFloat(document.getElementById('payCash').value) || 0,
        paidUpi: parseFloat(document.getElementById('payUPI').value) || 0,
        paidBank: parseFloat(document.getElementById('payBank').value) || 0,
...
function loadOrderForEdit(id) {
    ...
    if (document.getElementById('payCash')) document.getElementById('payCash').value = parseFloat(order.paidCash) || 0;
    if (document.getElementById('payUPI')) document.getElementById('payUPI').value = parseFloat(order.paidUpi) || 0;
    if (document.getElementById('payBank')) document.getElementById('payBank').value = parseFloat(order.paidBank) || 0;
